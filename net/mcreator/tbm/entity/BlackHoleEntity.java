...
import net.mcreator.tbm.procedures.BlackHoleOnEntityTickUpdateProcedure;
...
public class BlackHoleEntity extends Monster implements GeoEntity {
   ...
   public BlackHoleEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.BLACK_HOLE.get(), world);
   }
   ...
   public BlackHoleEntity(EntityType<BlackHoleEntity> type, Level world) {
      ...
      this.bossInfo = new ServerBossEvent(this.m_5446_(), BossBarColor.PINK, BossBarOverlay.PROGRESS);
      this.f_21364_ = 0;
      this.m_21557_(false);
      this.m_21530_();
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "bh");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      BlackHoleOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("s")) : PlayState.STOP;
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(BlackHoleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(BlackHoleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(BlackHoleEntity.class, EntityDataSerializers.f_135030_);
   }
}
