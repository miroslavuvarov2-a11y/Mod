...
import net.mcreator.tbm.procedures.Rocket3EntityFallsProcedure;
...
public class Rocket3Entity extends Monster {
   public Rocket3Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.ROCKET_3.get(), world);
   }

   public Rocket3Entity(EntityType<Rocket3Entity> type, Level world) {
      super(type, world);
      this.m_274367_(0.0F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public boolean m_142535_(float l, float d, DamageSource source) {
      Rocket3EntityFallsProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
