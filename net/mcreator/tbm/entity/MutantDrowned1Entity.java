...
import net.mcreator.tbm.procedures.MutantDrowned1EntityDiesProcedure;
import net.mcreator.tbm.procedures.MutantDrowned1OnEntityTickUpdateProcedure;
...
public class MutantDrowned1Entity extends Zombie implements GeoEntity {
   ...
   public MutantDrowned1Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_DROWNED_1.get(), world);
   }

   public MutantDrowned1Entity(EntityType<MutantDrowned1Entity> type, Level world) {
      super(type, world);
   ...
   public void m_6667_(DamageSource source) {
      ...
      MutantDrowned1EntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }

   public void m_6075_() {
      super.m_6075_();
      MutantDrowned1OnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static AttributeSupplier.Builder m_34328_() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, (double)70.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantDrowned1Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantDrowned1Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantDrowned1Entity.class, EntityDataSerializers.f_135030_);
   }
}
