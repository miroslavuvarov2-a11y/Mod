...
import net.mcreator.tbm.procedures.BoatEntityDiesProcedure;
...
public class BoatEntity extends Monster implements GeoEntity {
   ...
   public BoatEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.BOAT.get(), world);
   }

   public BoatEntity(EntityType<BoatEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "gd31");
   }
   ...
   public void m_6667_(DamageSource source) {
      ...
      BoatEntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(BoatEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(BoatEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(BoatEntity.class, EntityDataSerializers.f_135030_);
   }
}
