...
public class HandofmutantwitherEntity extends Monster implements GeoEntity {
   ...
   public HandofmutantwitherEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.HANDOFMUTANTWITHER.get(), world);
   }

   public HandofmutantwitherEntity(EntityType<HandofmutantwitherEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "mwh");
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22278_, (double)100.0F);
      return builder;
   }

   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("i")) : PlayState.STOP;
   }
   ...
   private PlayState attackingPredicate(AnimationState event) {
      ...
      if (this.swinging && event.getController().getAnimationState() == State.STOPPED) {
         ...
         return event.setAndContinue(RawAnimation.begin().thenPlay("a"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(HandofmutantwitherEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(HandofmutantwitherEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(HandofmutantwitherEntity.class, EntityDataSerializers.f_135030_);
   }
}
