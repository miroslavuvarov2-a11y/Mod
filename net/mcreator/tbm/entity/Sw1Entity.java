...
import net.mcreator.tbm.procedures.Sw1EntityDiesProcedure;
...
public class Sw1Entity extends Monster {
   public Sw1Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.SW_1.get(), world);
   }

   public Sw1Entity(EntityType<Sw1Entity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public void m_6667_(DamageSource source) {
      ...
      Sw1EntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }
