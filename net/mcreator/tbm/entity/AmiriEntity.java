...
public class AmiriEntity extends AbstractArrow implements ItemSupplier {
   public AmiriEntity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.AMIRI.get(), world);
   }

   public AmiriEntity(EntityType<? extends AmiriEntity> type, Level world) {
      super(type, world);
   }

   public AmiriEntity(EntityType<? extends AmiriEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public AmiriEntity(EntityType<? extends AmiriEntity> type, LivingEntity entity, Level world) {
   ...
   public static AmiriEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      AmiriEntity entityarrow = new AmiriEntity((EntityType)ThemutantmobsmodModEntities.AMIRI.get(), entity, world);
   ...
   public static AmiriEntity shoot(LivingEntity entity, LivingEntity target) {
      AmiriEntity entityarrow = new AmiriEntity((EntityType)ThemutantmobsmodModEntities.AMIRI.get(), entity, entity.m_9236_());
