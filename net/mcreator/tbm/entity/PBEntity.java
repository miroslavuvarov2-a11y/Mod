...
import net.mcreator.tbm.procedures.PBEntityFallsProcedure;
...
public class PBEntity extends Monster implements GeoEntity {
   ...
   public PBEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.PB.get(), world);
   }

   public PBEntity(EntityType<PBEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "texture");
   }
   ...
   public boolean m_142535_(float l, float d, DamageSource source) {
      PBEntityFallsProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(PBEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(PBEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(PBEntity.class, EntityDataSerializers.f_135030_);
   }
}
