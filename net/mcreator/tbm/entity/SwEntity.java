...
import net.mcreator.tbm.procedures.SwProjectileHitsPlayerProcedure;
import net.mcreator.tbm.procedures.SwWhileProjectileFlyingTickProcedure;
...
public class SwEntity extends AbstractArrow implements ItemSupplier {
   public SwEntity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.SW.get(), world);
   }

   public SwEntity(EntityType<? extends SwEntity> type, Level world) {
      super(type, world);
   }

   public SwEntity(EntityType<? extends SwEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public SwEntity(EntityType<? extends SwEntity> type, LivingEntity entity, Level world) {
   ...
   public void m_6123_(Player entity) {
      ...
      SwProjectileHitsPlayerProcedure.execute(entity);
   }

   public void m_5790_(EntityHitResult entityHitResult) {
      super.m_5790_(entityHitResult);
      SwProjectileHitsPlayerProcedure.execute(entityHitResult.m_82443_());
   }

   public void m_8119_() {
      super.m_8119_();
      SwWhileProjectileFlyingTickProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
      if (this.f_36703_) {
         this.m_146870_();
      }
   ...
   public static SwEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      SwEntity entityarrow = new SwEntity((EntityType)ThemutantmobsmodModEntities.SW.get(), entity, world);
   ...
   public static SwEntity shoot(LivingEntity entity, LivingEntity target) {
      SwEntity entityarrow = new SwEntity((EntityType)ThemutantmobsmodModEntities.SW.get(), entity, entity.m_9236_());
