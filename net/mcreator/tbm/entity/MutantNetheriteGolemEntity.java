...
public class MutantNetheriteGolemEntity extends IronGolem implements RangedAttackMob, GeoEntity {
   ...
   public MutantNetheriteGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_NETHERITE_GOLEM.get(), world);
   }

   public MutantNetheriteGolemEntity(EntityType<MutantNetheriteGolemEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "unnamed1");
   }
   ...
   protected void m_7472_(DamageSource source, int looting, boolean recentlyHitIn) {
      ...
      this.m_19983_(new ItemStack(Blocks.f_50721_));
   }

   public void m_7355_(BlockPos pos, BlockState blockIn) {
      this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.anvil.fall")), 0.15F, 1.0F);
   }
   ...
   public boolean m_6469_(DamageSource source, float amount) {
      if (source.m_276093_(DamageTypes.f_268631_)) {
         ...
         if (source.m_276093_(DamageTypes.f_268671_)) {
            ...
            return source.m_276093_(DamageTypes.f_268526_) ? false : super.m_6469_(source, amount);
         }
      } else {
         return false;
      }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantNetheriteGolemEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantNetheriteGolemEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantNetheriteGolemEntity.class, EntityDataSerializers.f_135030_);
   }
   ...
   public class RangedAttackGoal extends Goal {
      ...
      public void m_8041_() {
         ...
         this.seeTime = 0;
         this.attackTime = -1;
         ((MutantNetheriteGolemEntity)this.rangedAttackMob).f_19804_.m_135381_(MutantNetheriteGolemEntity.SHOOT, false);
      }
      ...
      public void m_8037_() {
         ...
         if (--this.attackTime == 0) {
            ...
            ((MutantNetheriteGolemEntity)this.rangedAttackMob).f_19804_.m_135381_(MutantNetheriteGolemEntity.SHOOT, true);
