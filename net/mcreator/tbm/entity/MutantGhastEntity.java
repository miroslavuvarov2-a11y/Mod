...
import net.mcreator.tbm.procedures.MutantGhastOnEntityTickUpdateProcedure;
...
public class MutantGhastEntity extends Monster implements RangedAttackMob, GeoEntity {
   ...
   public MutantGhastEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_GHAST.get(), world);
   }

   public MutantGhastEntity(EntityType<MutantGhastEntity> type, Level world) {
      super(type, world);
      this.cache = GeckoLibUtil.createInstanceCache(this);
      this.animationprocedure = "empty";
      this.bossInfo = new ServerBossEvent(this.m_5446_(), BossBarColor.RED, BossBarOverlay.NOTCHED_10);
      this.f_21364_ = 1000;
      this.m_21557_(false);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "bloody-ghast-on-planetminecraft-com11");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21346_.m_25352_(15, new NearestAttackableTargetGoal(this, IronGolem.class, false, false));
      ...
      this.f_21346_.m_25352_(20, new NearestAttackableTargetGoal(this, Villager.class, false, false));
   ...
   public SoundEvent m_7515_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.ghast.ambient"));
   }

   public SoundEvent m_7975_(DamageSource ds) {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.ghast.hurt"));
   }

   public SoundEvent m_5592_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.ghast.death"));
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      MutantGhastOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)ThemutantmobsmodModEntities.MUTANT_GHAST.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.m_46791_() != Difficulty.PEACEFUL && Monster.m_219009_(world, pos, random) && Mob.m_217057_(entityType, world, reason, pos, random));
   }

   public static AttributeSupplier.Builder createAttributes() {
      AttributeSupplier.Builder builder = Mob.m_21552_();
      builder = builder.m_22268_(Attributes.f_22279_, 0.8);
      builder = builder.m_22268_(Attributes.f_22276_, (double)600.0F);
      builder = builder.m_22268_(Attributes.f_22284_, (double)100.0F);
      builder = builder.m_22268_(Attributes.f_22281_, (double)25.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantGhastEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantGhastEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantGhastEntity.class, EntityDataSerializers.f_135030_);
   }
   ...
   public class RangedAttackGoal extends Goal {
      ...
      public void m_8041_() {
         ...
         this.seeTime = 0;
         this.attackTime = -1;
         ((MutantGhastEntity)this.rangedAttackMob).f_19804_.m_135381_(MutantGhastEntity.SHOOT, false);
      }
      ...
      public void m_8037_() {
         ...
         if (--this.attackTime == 0) {
            ...
            ((MutantGhastEntity)this.rangedAttackMob).f_19804_.m_135381_(MutantGhastEntity.SHOOT, true);
