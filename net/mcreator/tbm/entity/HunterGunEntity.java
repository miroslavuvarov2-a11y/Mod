...
public class HunterGunEntity extends AbstractArrow implements ItemSupplier {
   public HunterGunEntity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.HUNTER_GUN.get(), world);
   }

   public HunterGunEntity(EntityType<? extends HunterGunEntity> type, Level world) {
      super(type, world);
   }

   public HunterGunEntity(EntityType<? extends HunterGunEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public HunterGunEntity(EntityType<? extends HunterGunEntity> type, LivingEntity entity, Level world) {
   ...
   public static HunterGunEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      HunterGunEntity entityarrow = new HunterGunEntity((EntityType)ThemutantmobsmodModEntities.HUNTER_GUN.get(), entity, world);
   ...
   public static HunterGunEntity shoot(LivingEntity entity, LivingEntity target) {
      HunterGunEntity entityarrow = new HunterGunEntity((EntityType)ThemutantmobsmodModEntities.HUNTER_GUN.get(), entity, entity.m_9236_());
      ...
      entityarrow.m_20225_(true);
      entityarrow.m_36781_((double)12.0F);
