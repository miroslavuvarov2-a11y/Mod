...
import net.mcreator.tbm.procedures.BlockGoldProjectileHitsBlockProcedure;
...
public class BlockGoldEntity extends AbstractArrow implements ItemSupplier {
   public BlockGoldEntity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.BLOCK_GOLD.get(), world);
   }

   public BlockGoldEntity(EntityType<? extends BlockGoldEntity> type, Level world) {
      super(type, world);
   }

   public BlockGoldEntity(EntityType<? extends BlockGoldEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public BlockGoldEntity(EntityType<? extends BlockGoldEntity> type, LivingEntity entity, Level world) {
   ...
   public void m_6123_(Player entity) {
      ...
      BlockGoldProjectileHitsBlockProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }
   ...
   public static BlockGoldEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      BlockGoldEntity entityarrow = new BlockGoldEntity((EntityType)ThemutantmobsmodModEntities.BLOCK_GOLD.get(), entity, world);
   ...
   public static BlockGoldEntity shoot(LivingEntity entity, LivingEntity target) {
      BlockGoldEntity entityarrow = new BlockGoldEntity((EntityType)ThemutantmobsmodModEntities.BLOCK_GOLD.get(), entity, entity.m_9236_());
