...
import net.mcreator.tbm.procedures.PuppetofmutantwardenOnInitialEntitySpawnProcedure;
...
public class PuppetofmutantwardenEntity extends Monster implements GeoEntity {
   ...
   public PuppetofmutantwardenEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.PUPPETOFMUTANTWARDEN.get(), world);
   }

   public PuppetofmutantwardenEntity(EntityType<PuppetofmutantwardenEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "warden1");
   }
   ...
   public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
      ...
      PuppetofmutantwardenOnInitialEntitySpawnProcedure.execute(world, this);
      return retval;
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(PuppetofmutantwardenEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(PuppetofmutantwardenEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(PuppetofmutantwardenEntity.class, EntityDataSerializers.f_135030_);
   }
}
