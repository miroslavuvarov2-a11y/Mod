...
import net.mcreator.tbm.procedures.Sw2ProjectileHitsPlayerProcedure;
...
public class Sw2Entity extends AbstractArrow implements ItemSupplier {
   public Sw2Entity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.SW_2.get(), world);
   }

   public Sw2Entity(EntityType<? extends Sw2Entity> type, Level world) {
      super(type, world);
   }

   public Sw2Entity(EntityType<? extends Sw2Entity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public Sw2Entity(EntityType<? extends Sw2Entity> type, LivingEntity entity, Level world) {
   ...
   public void m_6123_(Player entity) {
      ...
      Sw2ProjectileHitsPlayerProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }
   ...
   public void m_8060_(BlockHitResult blockHitResult) {
      ...
      Sw2ProjectileHitsPlayerProcedure.execute(this.m_9236_(), (double)blockHitResult.m_82425_().m_123341_(), (double)blockHitResult.m_82425_().m_123342_(), (double)blockHitResult.m_82425_().m_123343_());
   }
   ...
   public static Sw2Entity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      Sw2Entity entityarrow = new Sw2Entity((EntityType)ThemutantmobsmodModEntities.SW_2.get(), entity, world);
   ...
   public static Sw2Entity shoot(LivingEntity entity, LivingEntity target) {
      Sw2Entity entityarrow = new Sw2Entity((EntityType)ThemutantmobsmodModEntities.SW_2.get(), entity, entity.m_9236_());
