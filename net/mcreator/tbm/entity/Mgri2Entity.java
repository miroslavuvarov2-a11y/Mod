...
import net.mcreator.tbm.procedures.Mgri2WhileProjectileFlyingTickProcedure;
...
public class Mgri2Entity extends AbstractArrow implements ItemSupplier {
   public Mgri2Entity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.MGRI_2.get(), world);
   }

   public Mgri2Entity(EntityType<? extends Mgri2Entity> type, Level world) {
      super(type, world);
   }

   public Mgri2Entity(EntityType<? extends Mgri2Entity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public Mgri2Entity(EntityType<? extends Mgri2Entity> type, LivingEntity entity, Level world) {
   ...
   public void m_8119_() {
      super.m_8119_();
      Mgri2WhileProjectileFlyingTickProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
      if (this.f_36703_) {
         this.m_146870_();
      }
   ...
   public static Mgri2Entity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      Mgri2Entity entityarrow = new Mgri2Entity((EntityType)ThemutantmobsmodModEntities.MGRI_2.get(), entity, world);
   ...
   public static Mgri2Entity shoot(LivingEntity entity, LivingEntity target) {
      Mgri2Entity entityarrow = new Mgri2Entity((EntityType)ThemutantmobsmodModEntities.MGRI_2.get(), entity, entity.m_9236_());
