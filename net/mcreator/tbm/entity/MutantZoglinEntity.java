...
import net.mcreator.tbm.procedures.MutantZoglinOnEntityTickUpdateProcedure;
...
public class MutantZoglinEntity extends Monster implements GeoEntity {
   ...
   public MutantZoglinEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_ZOGLIN.get(), world);
   }

   public MutantZoglinEntity(EntityType<MutantZoglinEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "unnamed_2");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21346_.m_25352_(11, new NearestAttackableTargetGoal(this, IronGolem.class, false, false));
      this.f_21346_.m_25352_(12, new NearestAttackableTargetGoal(this, Villager.class, false, false));
   }
   ...
   protected void m_7472_(DamageSource source, int looting, boolean recentlyHitIn) {
      ...
      this.m_19983_(new ItemStack(Items.f_42583_));
   }

   public SoundEvent m_7515_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.zoglin.ambient"));
   }

   public void m_7355_(BlockPos pos, BlockState blockIn) {
      this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.zoglin.step")), 0.15F, 1.0F);
   }

   public SoundEvent m_7975_(DamageSource ds) {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.zoglin.hurt"));
   }

   public SoundEvent m_5592_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.zoglin.death"));
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      MutantZoglinOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)ThemutantmobsmodModEntities.MUTANT_ZOGLIN.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.m_46791_() != Difficulty.PEACEFUL && Monster.m_219009_(world, pos, random) && Mob.m_217057_(entityType, world, reason, pos, random));
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22284_, (double)30.0F);
      ...
      builder = builder.m_22268_(Attributes.f_22282_, (double)5.0F);
      return builder;
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantZoglinEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantZoglinEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantZoglinEntity.class, EntityDataSerializers.f_135030_);
   }
}
