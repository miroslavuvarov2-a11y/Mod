...
public class GigaillagerV2Entity extends Monster implements RangedAttackMob, GeoEntity {
   ...
   public GigaillagerV2Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.GIGAILLAGER_V_2.get(), world);
   }

   public GigaillagerV2Entity(EntityType<GigaillagerV2Entity> type, Level world) {
      super(type, world);
      this.cache = GeckoLibUtil.createInstanceCache(this);
      this.animationprocedure = "empty";
      this.bossInfo = new ServerBossEvent(this.m_5446_(), BossBarColor.GREEN, BossBarOverlay.NOTCHED_12);
      this.f_21364_ = 500;
      this.m_21557_(false);
      this.m_21530_();
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "tjhd");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21346_.m_25352_(20, new NearestAttackableTargetGoal(this, IronGolem.class, false, false));
   ...
   protected void m_7472_(DamageSource source, int looting, boolean recentlyHitIn) {
      ...
      this.m_19983_(new ItemStack((ItemLike)ThemutantmobsmodModItems.MYSTERIOUS_POTION.get()));
   }
   ...
   private PlayState attackingPredicate(AnimationState event) {
      ...
      if ((this.swinging || (Boolean)this.f_19804_.m_135370_(SHOOT)) && event.getController().getAnimationState() == State.STOPPED) {
         ...
         return event.setAndContinue(RawAnimation.begin().thenPlay("spaw"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(GigaillagerV2Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(GigaillagerV2Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(GigaillagerV2Entity.class, EntityDataSerializers.f_135030_);
   }
   ...
   public class RangedAttackGoal extends Goal {
      ...
      public void m_8041_() {
         ...
         this.seeTime = 0;
         this.attackTime = -1;
         ((GigaillagerV2Entity)this.rangedAttackMob).f_19804_.m_135381_(GigaillagerV2Entity.SHOOT, false);
      }
      ...
      public void m_8037_() {
         ...
         if (--this.attackTime == 0) {
            ...
            ((GigaillagerV2Entity)this.rangedAttackMob).f_19804_.m_135381_(GigaillagerV2Entity.SHOOT, true);
