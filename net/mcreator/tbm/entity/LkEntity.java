...
import net.mcreator.tbm.procedures.LkWhileProjectileFlyingTickProcedure;
...
public class LkEntity extends AbstractArrow implements ItemSupplier {
   public LkEntity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.LK.get(), world);
   }

   public LkEntity(EntityType<? extends LkEntity> type, Level world) {
      super(type, world);
   }

   public LkEntity(EntityType<? extends LkEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public LkEntity(EntityType<? extends LkEntity> type, LivingEntity entity, Level world) {
   ...
   public void m_8119_() {
      super.m_8119_();
      LkWhileProjectileFlyingTickProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
      if (this.f_36703_) {
         this.m_146870_();
      }
   ...
   public static LkEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      LkEntity entityarrow = new LkEntity((EntityType)ThemutantmobsmodModEntities.LK.get(), entity, world);
   ...
   public static LkEntity shoot(LivingEntity entity, LivingEntity target) {
      LkEntity entityarrow = new LkEntity((EntityType)ThemutantmobsmodModEntities.LK.get(), entity, entity.m_9236_());
