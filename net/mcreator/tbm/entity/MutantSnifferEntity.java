...
import net.mcreator.tbm.procedures.MutantSnifferOnEntityTickUpdateProcedure;
...
public class MutantSnifferEntity extends Monster implements GeoEntity {
   ...
   public MutantSnifferEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_SNIFFER.get(), world);
   }

   public MutantSnifferEntity(EntityType<MutantSnifferEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "sniffer2");
   }
   ...
   protected void m_7472_(DamageSource source, int looting, boolean recentlyHitIn) {
      ...
      this.m_19983_(new ItemStack(Blocks.f_50268_));
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      MutantSnifferOnEntityTickUpdateProcedure.execute(this.m_9236_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)ThemutantmobsmodModEntities.MUTANT_SNIFFER.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.m_8055_(pos.m_7495_()).m_204336_(BlockTags.f_184228_) && world.m_45524_(pos, 0) > 8);
   }

   public static AttributeSupplier.Builder createAttributes() {
      AttributeSupplier.Builder builder = Mob.m_21552_();
      builder = builder.m_22268_(Attributes.f_22279_, 0.3);
      builder = builder.m_22268_(Attributes.f_22276_, (double)350.0F);
      builder = builder.m_22268_(Attributes.f_22284_, (double)12.0F);
      builder = builder.m_22268_(Attributes.f_22281_, (double)19.0F);
      builder = builder.m_22268_(Attributes.f_22277_, (double)128.0F);
      builder = builder.m_22268_(Attributes.f_22278_, (double)1000.0F);
      builder = builder.m_22268_(Attributes.f_22282_, (double)2.0F);
      return builder;
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantSnifferEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantSnifferEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantSnifferEntity.class, EntityDataSerializers.f_135030_);
   }
}
