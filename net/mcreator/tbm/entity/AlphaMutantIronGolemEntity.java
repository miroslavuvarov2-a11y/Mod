...
import net.mcreator.tbm.procedures.AlphaMutantIronGolemOnEntityTickUpdateProcedure;
...
public class AlphaMutantIronGolemEntity extends IronGolem implements GeoEntity {
   ...
   public AlphaMutantIronGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.ALPHA_MUTANT_IRON_GOLEM.get(), world);
   }

   public AlphaMutantIronGolemEntity(EntityType<AlphaMutantIronGolemEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "iron_golem1");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      AlphaMutantIronGolemOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static AttributeSupplier.Builder m_28883_() {
      ...
      builder = builder.m_22268_(Attributes.f_22281_, (double)60.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(AlphaMutantIronGolemEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(AlphaMutantIronGolemEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(AlphaMutantIronGolemEntity.class, EntityDataSerializers.f_135030_);
   }
}
