...
import net.mcreator.tbm.procedures.TowerofmutantwitherOnEntityTickUpdateProcedure;
...
public class TowerofmutantwitherEntity extends Monster {
   public TowerofmutantwitherEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.TOWEROFMUTANTWITHER.get(), world);
   }

   public TowerofmutantwitherEntity(EntityType<TowerofmutantwitherEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public void m_6075_() {
      super.m_6075_();
      TowerofmutantwitherOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
