...
import net.mcreator.tbm.procedures.WeaponofmutantwardenOnEntityTickUpdateProcedure;
...
public class WeaponofmutantwardenEntity extends PathfinderMob {
   public WeaponofmutantwardenEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.WEAPONOFMUTANTWARDEN.get(), world);
   }

   public WeaponofmutantwardenEntity(EntityType<WeaponofmutantwardenEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.0F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public void m_6075_() {
      super.m_6075_();
      WeaponofmutantwardenOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
   }
