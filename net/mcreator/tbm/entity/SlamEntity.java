...
import net.mcreator.tbm.procedures.SlamProjectileHitsPlayerProcedure;
...
public class SlamEntity extends AbstractArrow implements ItemSupplier {
   public SlamEntity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.SLAM.get(), world);
   }

   public SlamEntity(EntityType<? extends SlamEntity> type, Level world) {
      super(type, world);
   }

   public SlamEntity(EntityType<? extends SlamEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public SlamEntity(EntityType<? extends SlamEntity> type, LivingEntity entity, Level world) {
   ...
   public void m_6123_(Player entity) {
      ...
      SlamProjectileHitsPlayerProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }
   ...
   public void m_8060_(BlockHitResult blockHitResult) {
      ...
      SlamProjectileHitsPlayerProcedure.execute(this.m_9236_(), (double)blockHitResult.m_82425_().m_123341_(), (double)blockHitResult.m_82425_().m_123342_(), (double)blockHitResult.m_82425_().m_123343_());
   }
   ...
   public static SlamEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      SlamEntity entityarrow = new SlamEntity((EntityType)ThemutantmobsmodModEntities.SLAM.get(), entity, world);
   ...
   public static SlamEntity shoot(LivingEntity entity, LivingEntity target) {
      SlamEntity entityarrow = new SlamEntity((EntityType)ThemutantmobsmodModEntities.SLAM.get(), entity, entity.m_9236_());
