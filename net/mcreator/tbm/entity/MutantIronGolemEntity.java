...
public class MutantIronGolemEntity extends IronGolem implements GeoEntity {
   ...
   public MutantIronGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_IRON_GOLEM.get(), world);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "mutant1");
   }
   ...
   public static AttributeSupplier.Builder m_28883_() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, (double)270.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantIronGolemEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantIronGolemEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantIronGolemEntity.class, EntityDataSerializers.f_135030_);
   }
}
