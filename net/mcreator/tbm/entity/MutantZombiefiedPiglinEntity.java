...
import net.mcreator.tbm.procedures.MutantZombiefiedPiglinOnEntityTickUpdateProcedure;
...
public class MutantZombiefiedPiglinEntity extends Monster implements GeoEntity {
   ...
   public MutantZombiefiedPiglinEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_ZOMBIFIED_PIGLIN.get(), world);
   }

   public MutantZombiefiedPiglinEntity(EntityType<MutantZombiefiedPiglinEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "vanilla-zombified-piglin-original-skin-on-planetminecraft-com1");
   }
   ...
   public SoundEvent m_7515_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.piglin.ambient"));
   }

   public void m_7355_(BlockPos pos, BlockState blockIn) {
      this.m_5496_((SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.piglin_brute.hurt")), 0.15F, 1.0F);
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      MutantZombiefiedPiglinOnEntityTickUpdateProcedure.execute(this.m_9236_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)ThemutantmobsmodModEntities.MUTANT_ZOMBIFIED_PIGLIN.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.m_46791_() != Difficulty.PEACEFUL && Monster.m_219009_(world, pos, random) && Mob.m_217057_(entityType, world, reason, pos, random));
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22281_, (double)11.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantZombiefiedPiglinEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantZombiefiedPiglinEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantZombiefiedPiglinEntity.class, EntityDataSerializers.f_135030_);
   }
}
