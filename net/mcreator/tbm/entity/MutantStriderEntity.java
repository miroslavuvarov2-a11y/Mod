...
public class MutantStriderEntity extends Monster implements RangedAttackMob, GeoEntity {
   ...
   public MutantStriderEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_STRIDER.get(), world);
   }

   public MutantStriderEntity(EntityType<MutantStriderEntity> type, Level world) {
      super(type, world);
      this.cache = GeckoLibUtil.createInstanceCache(this);
      this.animationprocedure = "empty";
      this.bossInfo = new ServerBossEvent(this.m_5446_(), BossBarColor.RED, BossBarOverlay.PROGRESS);
      this.f_21364_ = 1000;
      this.m_21557_(false);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "happy-strider-on-planetminecraft-com1");
   }
   ...
   public SoundEvent m_7515_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.strider.ambient"));
   }

   public SoundEvent m_7975_(DamageSource ds) {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.strider.hurt"));
   }

   public SoundEvent m_5592_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.strider.death"));
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)ThemutantmobsmodModEntities.MUTANT_STRIDER.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.m_46791_() != Difficulty.PEACEFUL && Monster.m_219009_(world, pos, random) && Mob.m_217057_(entityType, world, reason, pos, random));
   }

   public static AttributeSupplier.Builder createAttributes() {
      AttributeSupplier.Builder builder = Mob.m_21552_();
      builder = builder.m_22268_(Attributes.f_22279_, 0.3);
      builder = builder.m_22268_(Attributes.f_22276_, (double)450.0F);
      builder = builder.m_22268_(Attributes.f_22284_, (double)100.0F);
      builder = builder.m_22268_(Attributes.f_22281_, (double)30.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantStriderEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantStriderEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantStriderEntity.class, EntityDataSerializers.f_135030_);
   }
   ...
   public class RangedAttackGoal extends Goal {
      ...
      public void m_8041_() {
         ...
         this.seeTime = 0;
         this.attackTime = -1;
         ((MutantStriderEntity)this.rangedAttackMob).f_19804_.m_135381_(MutantStriderEntity.SHOOT, false);
      }
      ...
      public void m_8037_() {
         ...
         if (--this.attackTime == 0) {
            ...
            ((MutantStriderEntity)this.rangedAttackMob).f_19804_.m_135381_(MutantStriderEntity.SHOOT, true);
