...
import net.mcreator.tbm.procedures.WomwProjectileHitsBlockProcedure;
...
public class WomwEntity extends AbstractArrow implements ItemSupplier {
   public WomwEntity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.WOMW.get(), world);
   }

   public WomwEntity(EntityType<? extends WomwEntity> type, Level world) {
      super(type, world);
   }

   public WomwEntity(EntityType<? extends WomwEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public WomwEntity(EntityType<? extends WomwEntity> type, LivingEntity entity, Level world) {
   ...
   public void m_8060_(BlockHitResult blockHitResult) {
      ...
      WomwProjectileHitsBlockProcedure.execute(this.m_9236_(), (double)blockHitResult.m_82425_().m_123341_(), (double)blockHitResult.m_82425_().m_123342_(), (double)blockHitResult.m_82425_().m_123343_());
   }
   ...
   public static WomwEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      WomwEntity entityarrow = new WomwEntity((EntityType)ThemutantmobsmodModEntities.WOMW.get(), entity, world);
   ...
   public static WomwEntity shoot(LivingEntity entity, LivingEntity target) {
      WomwEntity entityarrow = new WomwEntity((EntityType)ThemutantmobsmodModEntities.WOMW.get(), entity, entity.m_9236_());
