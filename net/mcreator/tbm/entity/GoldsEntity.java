...
public class GoldsEntity extends Monster {
   public GoldsEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.GOLDS.get(), world);
   }

   public GoldsEntity(EntityType<GoldsEntity> type, Level world) {
      super(type, world);
      this.m_274367_(0.6F);
      this.f_21364_ = 0;
      this.m_21557_(false);
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22277_, (double)17.0F);
      return builder;
   }
}
