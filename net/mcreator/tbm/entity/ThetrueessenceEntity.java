...
import net.mcreator.tbm.procedures.ThetrueessenceEntityDiesProcedure;
...
public class ThetrueessenceEntity extends Monster implements GeoEntity {
   ...
   public ThetrueessenceEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.THETRUEESSENCE.get(), world);
   }

   public ThetrueessenceEntity(EntityType<ThetrueessenceEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "270e915187dd17bc");
   }
   ...
   public void m_6667_(DamageSource source) {
      ...
      ThetrueessenceEntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, (double)500.0F);
      builder = builder.m_22268_(Attributes.f_22284_, (double)100.0F);
      builder = builder.m_22268_(Attributes.f_22281_, (double)10.0F);
      builder = builder.m_22268_(Attributes.f_22277_, (double)25.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(ThetrueessenceEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(ThetrueessenceEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(ThetrueessenceEntity.class, EntityDataSerializers.f_135030_);
   }
}
