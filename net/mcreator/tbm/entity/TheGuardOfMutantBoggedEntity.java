...
public class TheGuardOfMutantBoggedEntity extends Skeleton implements GeoEntity {
   ...
   public TheGuardOfMutantBoggedEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.THE_GUARD_OF_MUTANT_BOGGED.get(), world);
   }

   public TheGuardOfMutantBoggedEntity(EntityType<TheGuardOfMutantBoggedEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "bogged-skeleton-skin-1-21-on-planetminecraft-com1");
   }
   ...
   public static AttributeSupplier.Builder m_32166_() {
      ...
      builder = builder.m_22268_(Attributes.f_22284_, (double)5.0F);
      builder = builder.m_22268_(Attributes.f_22281_, (double)5.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(TheGuardOfMutantBoggedEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(TheGuardOfMutantBoggedEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(TheGuardOfMutantBoggedEntity.class, EntityDataSerializers.f_135030_);
   }
}
