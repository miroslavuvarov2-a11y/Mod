...
import net.mcreator.tbm.procedures.MutantDrowned2EntityDiesProcedure;
import net.mcreator.tbm.procedures.MutantDrowned2OnEntityTickUpdateProcedure;
...
public class MutantDrowned2Entity extends Zombie implements GeoEntity {
   ...
   public MutantDrowned2Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_DROWNED_2.get(), world);
   }

   public MutantDrowned2Entity(EntityType<MutantDrowned2Entity> type, Level world) {
      super(type, world);
   ...
   public SoundEvent m_7515_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("themutantmobsmod:mda"));
   }
   ...
   public void m_6667_(DamageSource source) {
      ...
      MutantDrowned2EntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }

   public void m_6075_() {
      super.m_6075_();
      MutantDrowned2OnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantDrowned2Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantDrowned2Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantDrowned2Entity.class, EntityDataSerializers.f_135030_);
   }
}
