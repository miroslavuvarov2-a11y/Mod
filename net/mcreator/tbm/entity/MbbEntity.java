...
import net.mcreator.tbm.procedures.MbbWhileProjectileFlyingTickProcedure;
...
public class MbbEntity extends AbstractArrow implements ItemSupplier {
   public MbbEntity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.MBB.get(), world);
   }
   ...
   public void m_8119_() {
      super.m_8119_();
      MbbWhileProjectileFlyingTickProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
      if (this.f_36703_) {
         this.m_146870_();
      }
   ...
   public static MbbEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      MbbEntity entityarrow = new MbbEntity((EntityType)ThemutantmobsmodModEntities.MBB.get(), entity, world);
   ...
   public static MbbEntity shoot(LivingEntity entity, LivingEntity target) {
      MbbEntity entityarrow = new MbbEntity((EntityType)ThemutantmobsmodModEntities.MBB.get(), entity, entity.m_9236_());
