...
import net.mcreator.tbm.procedures.MutantPiglinBruteOnEntityTickUpdateProcedure;
...
public class MutantPiglinBruteEntity extends Monster implements GeoEntity {
   ...
   public MutantPiglinBruteEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_PIGLIN_BRUTE.get(), world);
   }

   public MutantPiglinBruteEntity(EntityType<MutantPiglinBruteEntity> type, Level world) {
      super(type, world);
      this.cache = GeckoLibUtil.createInstanceCache(this);
      this.animationprocedure = "empty";
      this.bossInfo = new ServerBossEvent(this.m_5446_(), BossBarColor.YELLOW, BossBarOverlay.NOTCHED_6);
      this.f_21364_ = 500;
      this.m_21557_(false);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "piglin_brute1");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      MutantPiglinBruteOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)ThemutantmobsmodModEntities.MUTANT_PIGLIN_BRUTE.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.m_46791_() != Difficulty.PEACEFUL && Monster.m_219009_(world, pos, random) && Mob.m_217057_(entityType, world, reason, pos, random));
   }

   public static AttributeSupplier.Builder createAttributes() {
      AttributeSupplier.Builder builder = Mob.m_21552_();
      builder = builder.m_22268_(Attributes.f_22279_, 0.3);
      builder = builder.m_22268_(Attributes.f_22276_, (double)700.0F);
      builder = builder.m_22268_(Attributes.f_22284_, (double)20.0F);
      builder = builder.m_22268_(Attributes.f_22281_, (double)12.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantPiglinBruteEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantPiglinBruteEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantPiglinBruteEntity.class, EntityDataSerializers.f_135030_);
   }
}
