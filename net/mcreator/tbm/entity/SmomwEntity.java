...
import net.mcreator.tbm.procedures.SmomwOnEntityTickUpdateProcedure;
...
public class SmomwEntity extends PathfinderMob implements GeoEntity {
   ...
   public SmomwEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.SMOMW.get(), world);
   }

   public SmomwEntity(EntityType<SmomwEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "texture18");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      SmomwOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(SmomwEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(SmomwEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(SmomwEntity.class, EntityDataSerializers.f_135030_);
   }
}
