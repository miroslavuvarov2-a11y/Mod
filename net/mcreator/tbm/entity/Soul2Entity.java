...
import net.mcreator.tbm.procedures.Soul2OnInitialEntitySpawnProcedure;
...
public class Soul2Entity extends Monster implements GeoEntity {
   ...
   public Soul2Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.SOUL_2.get(), world);
   }

   public Soul2Entity(EntityType<Soul2Entity> type, Level world) {
      super(type, world);
   ...
   public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
      ...
      Soul2OnInitialEntitySpawnProcedure.execute(world, this);
      return retval;
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(Soul2Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(Soul2Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(Soul2Entity.class, EntityDataSerializers.f_135030_);
   }
}
