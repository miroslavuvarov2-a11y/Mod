...
public class IronGolemHelicopterEntity extends IronGolem implements GeoEntity {
   ...
   public IronGolemHelicopterEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.IRON_GOLEM_HELICOPTER.get(), world);
   }

   public IronGolemHelicopterEntity(EntityType<IronGolemHelicopterEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "iron_golem21");
   }
   ...
   protected void m_8099_() {
      super.m_8099_();
      this.f_21345_.m_25352_(1, new LeapAtTargetGoal(this, 0.5F));
      this.f_21345_.m_25352_(2, new RandomStrollGoal(this, 0.8, 20) {
         protected Vec3 m_7037_() {
            RandomSource random = IronGolemHelicopterEntity.this.m_217043_();
            double dir_x = IronGolemHelicopterEntity.this.m_20185_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_y = IronGolemHelicopterEntity.this.m_20186_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_z = IronGolemHelicopterEntity.this.m_20189_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
   ...
   private PlayState attackingPredicate(AnimationState event) {
      ...
      if (this.swinging && event.getController().getAnimationState() == State.STOPPED) {
         ...
         return event.setAndContinue(RawAnimation.begin().thenPlay("idle2"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(IronGolemHelicopterEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(IronGolemHelicopterEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(IronGolemHelicopterEntity.class, EntityDataSerializers.f_135030_);
   }
}
