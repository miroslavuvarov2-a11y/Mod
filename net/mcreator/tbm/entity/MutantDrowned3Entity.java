...
import net.mcreator.tbm.procedures.MutantDrowned3OnEntityTickUpdateProcedure;
...
public class MutantDrowned3Entity extends Zombie implements GeoEntity {
   ...
   public MutantDrowned3Entity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_DROWNED_3.get(), world);
   }

   public MutantDrowned3Entity(EntityType<MutantDrowned3Entity> type, Level world) {
      super(type, world);
   ...
   public void m_6075_() {
      super.m_6075_();
      MutantDrowned3OnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantDrowned3Entity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantDrowned3Entity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantDrowned3Entity.class, EntityDataSerializers.f_135030_);
   }
}
