...
import net.mcreator.tbm.procedures.SoulOnEntityTickUpdateProcedure;
...
public class SoulEntity extends Monster implements GeoEntity {
   ...
   public SoulEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.SOUL.get(), world);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "texture16");
   }
   ...
   public void m_6075_() {
      super.m_6075_();
      SoulOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, (double)50.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(SoulEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(SoulEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(SoulEntity.class, EntityDataSerializers.f_135030_);
   }
}
