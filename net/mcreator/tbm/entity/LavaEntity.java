...
import net.mcreator.tbm.procedures.LavaWhileProjectileFlyingTickProcedure;
import net.mcreator.tbm.procedures.LavaWhileProjectileFlyingTickrProcedure;
...
public class LavaEntity extends AbstractArrow implements ItemSupplier {
   public LavaEntity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.LAVA.get(), world);
   }

   public LavaEntity(EntityType<? extends LavaEntity> type, Level world) {
      super(type, world);
   }

   public LavaEntity(EntityType<? extends LavaEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public LavaEntity(EntityType<? extends LavaEntity> type, LivingEntity entity, Level world) {
   ...
   public ItemStack m_7846_() {
      return new ItemStack(Blocks.f_50450_);
   }
   ...
   public void m_6123_(Player entity) {
      ...
      LavaWhileProjectileFlyingTickProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }
   ...
   public void m_8119_() {
      super.m_8119_();
      LavaWhileProjectileFlyingTickrProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
      if (this.f_36703_) {
         this.m_146870_();
      }
   ...
   public static LavaEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      LavaEntity entityarrow = new LavaEntity((EntityType)ThemutantmobsmodModEntities.LAVA.get(), entity, world);
   ...
   public static LavaEntity shoot(LivingEntity entity, LivingEntity target) {
      LavaEntity entityarrow = new LavaEntity((EntityType)ThemutantmobsmodModEntities.LAVA.get(), entity, entity.m_9236_());
