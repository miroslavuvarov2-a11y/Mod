...
import net.mcreator.tbm.procedures.TheQueenMutantEntityIsHurtProcedure;
import net.mcreator.tbm.procedures.TheQueenMutantOnEntityTickUpdateProcedure;
...
public class TheQueenMutantEntity extends Monster implements GeoEntity {
   ...
   public TheQueenMutantEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.THE_QUEEN_MUTANT.get(), world);
   }

   public TheQueenMutantEntity(EntityType<TheQueenMutantEntity> type, Level world) {
      super(type, world);
      this.cache = GeckoLibUtil.createInstanceCache(this);
      this.animationprocedure = "empty";
      this.bossInfo = new ServerBossEvent(this.m_5446_(), BossBarColor.PURPLE, BossBarOverlay.NOTCHED_20);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "tqm");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21346_.m_25352_(9, new NearestAttackableTargetGoal(this, IronGolem.class, false, false));
   }
   ...
   protected void m_7472_(DamageSource source, int looting, boolean recentlyHitIn) {
      ...
      this.m_19983_(new ItemStack((ItemLike)ThemutantmobsmodModItems.ITEM_OF_THE_QUEEN_MUTANT.get()));
   }
   ...
   public boolean m_6469_(DamageSource source, float amount) {
      TheQueenMutantEntityIsHurtProcedure.execute(this);
   ...
   public void m_6075_() {
      super.m_6075_();
      TheQueenMutantOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, (double)1000.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(TheQueenMutantEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(TheQueenMutantEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(TheQueenMutantEntity.class, EntityDataSerializers.f_135030_);
   }
}
