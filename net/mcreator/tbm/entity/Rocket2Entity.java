...
import net.mcreator.tbm.procedures.Rocket2WhileProjectileFlyingTickProcedure;
...
public class Rocket2Entity extends AbstractArrow implements ItemSupplier {
   public Rocket2Entity(PlayMessages.SpawnEntity packet, Level world) {
      super((EntityType)ThemutantmobsmodModEntities.ROCKET_2.get(), world);
   }

   public Rocket2Entity(EntityType<? extends Rocket2Entity> type, Level world) {
      super(type, world);
   }

   public Rocket2Entity(EntityType<? extends Rocket2Entity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world);
   }

   public Rocket2Entity(EntityType<? extends Rocket2Entity> type, LivingEntity entity, Level world) {
   ...
   public void m_8119_() {
      super.m_8119_();
      Rocket2WhileProjectileFlyingTickProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
      if (this.f_36703_) {
         this.m_146870_();
      }
   ...
   public static Rocket2Entity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      Rocket2Entity entityarrow = new Rocket2Entity((EntityType)ThemutantmobsmodModEntities.ROCKET_2.get(), entity, world);
   ...
   public static Rocket2Entity shoot(LivingEntity entity, LivingEntity target) {
      Rocket2Entity entityarrow = new Rocket2Entity((EntityType)ThemutantmobsmodModEntities.ROCKET_2.get(), entity, entity.m_9236_());
