...
public class ThehandofmutantboggedEntity extends Zombie implements GeoEntity {
   ...
   public ThehandofmutantboggedEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.THEHANDOFMUTANTBOGGED.get(), world);
   }

   public ThehandofmutantboggedEntity(EntityType<ThehandofmutantboggedEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "thomb");
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(ThehandofmutantboggedEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(ThehandofmutantboggedEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(ThehandofmutantboggedEntity.class, EntityDataSerializers.f_135030_);
   }
}
