...
import net.mcreator.tbm.procedures.MutantDrownedEntityDiesProcedure;
import net.mcreator.tbm.procedures.MutantDrownedOnEntityTickUpdateProcedure;
...
public class MutantDrownedEntity extends Zombie implements GeoEntity {
   ...
   public MutantDrownedEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.MUTANT_DROWNED.get(), world);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "mdrowned");
   }
   ...
   public SoundEvent m_7515_() {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("themutantmobsmod:mda1"));
   }

   public SoundEvent m_7975_(DamageSource ds) {
      return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("themutantmobsmod:mdh"));
   }
   ...
   public void m_6667_(DamageSource source) {
      ...
      MutantDrownedEntityDiesProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_());
   }

   public void m_6075_() {
      super.m_6075_();
      MutantDrownedOnEntityTickUpdateProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)ThemutantmobsmodModEntities.MUTANT_DROWNED.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.m_46791_() != Difficulty.PEACEFUL && Monster.m_219009_(world, pos, random) && Mob.m_217057_(entityType, world, reason, pos, random));
   }

   public static AttributeSupplier.Builder m_34328_() {
      AttributeSupplier.Builder builder = Mob.m_21552_();
      builder = builder.m_22268_(Attributes.f_22279_, 0.24);
      builder = builder.m_22268_(Attributes.f_22276_, (double)300.0F);
      builder = builder.m_22268_(Attributes.f_22284_, (double)10.0F);
      ...
      builder = builder.m_22268_(Attributes.f_22282_, (double)3.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(MutantDrownedEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(MutantDrownedEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(MutantDrownedEntity.class, EntityDataSerializers.f_135030_);
   }
}
