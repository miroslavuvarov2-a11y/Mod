...
public class TheHandofMutantDrownedEntity extends Zombie implements GeoEntity {
   ...
   public TheHandofMutantDrownedEntity(PlayMessages.SpawnEntity packet, Level world) {
      this((EntityType)ThemutantmobsmodModEntities.THE_HANDOF_MUTANT_DROWNED.get(), world);
   }

   public TheHandofMutantDrownedEntity(EntityType<TheHandofMutantDrownedEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "mdsh");
   }
   ...
   public static AttributeSupplier.Builder m_34328_() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, (double)40.0F);
      builder = builder.m_22268_(Attributes.f_22284_, (double)10.0F);
      builder = builder.m_22268_(Attributes.f_22281_, (double)8.0F);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(TheHandofMutantDrownedEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(TheHandofMutantDrownedEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(TheHandofMutantDrownedEntity.class, EntityDataSerializers.f_135030_);
   }
}
