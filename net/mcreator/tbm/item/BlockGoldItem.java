...
public class BlockGoldItem extends Item {
   public BlockGoldItem() {
   ...
   public void m_5551_(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
      if (!world.m_5776_() && entityLiving instanceof ServerPlayer entity) {
         ...
         BlockGoldEntity entityarrow = BlockGoldEntity.shoot(world, entity, world.m_213780_(), 1.0F, (double)1.0F, 1);
