...
import net.mcreator.tbm.procedures.MsbRangedItemUsedProcedure;
...
public class MsbItem extends Item {
   public MsbItem() {
   ...
   public void m_5551_(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
      if (!world.m_5776_() && entityLiving instanceof ServerPlayer entity) {
         ...
         MsbEntity entityarrow = MsbEntity.shoot(world, entity, world.m_213780_(), 1.5F, (double)5.0F, 2);
         itemstack.m_41622_(1, entity, (e) -> e.m_21190_(entity.m_7655_()));
         entityarrow.f_36705_ = Pickup.DISALLOWED;
         MsbRangedItemUsedProcedure.execute(entity, itemstack);
      }
