...
public class SuperSkullItem extends Item {
   public SuperSkullItem() {
   ...
   public void m_5551_(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
      if (!world.m_5776_() && entityLiving instanceof ServerPlayer entity) {
         ...
         SuperSkullEntity entityarrow = SuperSkullEntity.shoot(world, entity, world.m_213780_(), 1.0F, (double)150.0F, 5);
