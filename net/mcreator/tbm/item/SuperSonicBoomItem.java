...
public class SuperSonicBoomItem extends Item {
   public SuperSonicBoomItem() {
   ...
   public void m_5551_(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
      if (!world.m_5776_() && entityLiving instanceof ServerPlayer entity) {
         ...
         SuperSonicBoomEntity entityarrow = SuperSonicBoomEntity.shoot(world, entity, world.m_213780_(), 10.0F, (double)50.0F, 5);
