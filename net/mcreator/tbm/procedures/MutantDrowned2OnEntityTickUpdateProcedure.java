...
public class MutantDrowned2OnEntityTickUpdateProcedure {
      ...
      if (entity != null) {
         ...
         if (entity.getPersistentData().m_128459_("IA") == (double)120.0F) {
            ...
            if (entity instanceof GeoEntity && entity instanceof MutantDrowned2Entity) {
               ((MutantDrowned2Entity)entity).setAnimation("sh");
            }
         ...
         if (entity.getPersistentData().m_128459_("IA") == (double)123.0F) {
            ThemutantmobsmodMod.queueServerWork(1, () -> entity.getPersistentData().m_128347_("IA", (double)0.0F));
            if (entity instanceof GeoEntity && entity instanceof MutantDrowned2Entity) {
               ((MutantDrowned2Entity)entity).setAnimation("summon");
            }
         ...
         if (entity.getPersistentData().m_128459_("IA") == (double)122.0F) {
            ThemutantmobsmodMod.queueServerWork(1, () -> entity.getPersistentData().m_128347_("IA", (double)0.0F));
            if (entity instanceof GeoEntity && entity instanceof MutantDrowned2Entity) {
               ((MutantDrowned2Entity)entity).setAnimation("attack");
            }
