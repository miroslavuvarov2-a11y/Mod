...
public class MutantDrowned1OnEntityTickUpdateProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         if (entity.getPersistentData().m_128459_("IA") == (double)119.0F) {
            entity.getPersistentData().m_128347_("IA", (double)Mth.m_216271_(RandomSource.m_216327_(), 120, 122));
         }
         ...
         if (entity.getPersistentData().m_128459_("IA") == (double)120.0F) {
            ...
            if (entity instanceof GeoEntity && entity instanceof MutantDrowned1Entity) {
               ((MutantDrowned1Entity)entity).setAnimation("sh");
            }
         ...
         if (entity.getPersistentData().m_128459_("IA") == (double)123.0F) {
            ThemutantmobsmodMod.queueServerWork(1, () -> entity.getPersistentData().m_128347_("IA", (double)0.0F));
            if (entity instanceof GeoEntity && entity instanceof MutantDrowned1Entity) {
               ((MutantDrowned1Entity)entity).setAnimation("summon");
            }
            ...
            ThemutantmobsmodMod.queueServerWork(15, () -> ThemutantmobsmodMod.queueServerWork(4, () -> {
         ...
         if (entity.getPersistentData().m_128459_("IA") == (double)121.0F) {
            ...
            ThemutantmobsmodMod.queueServerWork(15, () -> ThemutantmobsmodMod.queueServerWork(7, () -> {
                  if (world instanceof ServerLevel _level) {
         ...
         if (entity.getPersistentData().m_128459_("IA") == (double)122.0F) {
            ThemutantmobsmodMod.queueServerWork(1, () -> entity.getPersistentData().m_128347_("IA", (double)0.0F));
            if (entity instanceof GeoEntity && entity instanceof MutantDrowned1Entity) {
               ((MutantDrowned1Entity)entity).setAnimation("attack");
            }
