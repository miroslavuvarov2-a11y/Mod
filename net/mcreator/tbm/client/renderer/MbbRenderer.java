...
public class MbbRenderer extends EntityRenderer<MbbEntity> {
   ...
   public MbbRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelarrow(context.m_174023_(Modelarrow.LAYER_LOCATION));
   }

   public void render(MbbEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(MbbEntity entity) {
      return texture;
   }
}
