...
public class Sw2Renderer extends EntityRenderer<Sw2Entity> {
   ...
   public Sw2Renderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modeltd(context.m_174023_(Modeltd.LAYER_LOCATION));
   }

   public void render(Sw2Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(Sw2Entity entity) {
      return texture;
   }
}
