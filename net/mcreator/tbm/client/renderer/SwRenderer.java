...
public class SwRenderer extends EntityRenderer<SwEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/sw1.png");
   private final Modelsw1 model;

   public SwRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelsw1(context.m_174023_(Modelsw1.LAYER_LOCATION));
   }

   public void render(SwEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(SwEntity entity) {
      return texture;
   }
}
