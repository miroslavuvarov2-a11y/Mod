...
public class LkRenderer extends EntityRenderer<LkEntity> {
   ...
   public LkRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modeltd(context.m_174023_(Modeltd.LAYER_LOCATION));
   }

   public void render(LkEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(LkEntity entity) {
      return texture;
   }
}
