...
public class MeddsRenderer extends EntityRenderer<MeddsEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/edds.png");
   private final Modeledds model;

   public MeddsRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modeledds(context.m_174023_(Modeledds.LAYER_LOCATION));
   }

   public void render(MeddsEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(MeddsEntity entity) {
      return texture;
   }
}
