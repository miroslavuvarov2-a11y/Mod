...
public class HjRenderer extends EntityRenderer<HjEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/deeet.png");
   private final ModelDeeet2 model;

   public HjRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new ModelDeeet2(context.m_174023_(ModelDeeet2.LAYER_LOCATION));
   }

   public void render(HjEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(HjEntity entity) {
      return texture;
   }
}
