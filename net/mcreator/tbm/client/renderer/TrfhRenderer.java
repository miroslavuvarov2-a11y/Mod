...
public class TrfhRenderer extends EntityRenderer<TrfhEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/g.png");
   private final Modelgold1 model;

   public TrfhRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelgold1(context.m_174023_(Modelgold1.LAYER_LOCATION));
   }

   public void render(TrfhEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(TrfhEntity entity) {
      return texture;
   }
}
