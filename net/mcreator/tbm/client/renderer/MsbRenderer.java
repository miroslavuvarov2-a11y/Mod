...
public class MsbRenderer extends EntityRenderer<MsbEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/mstray2.png");
   private final Modelarrow model;

   public MsbRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelarrow(context.m_174023_(Modelarrow.LAYER_LOCATION));
   }

   public void render(MsbEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(MsbEntity entity) {
      return texture;
   }
}
