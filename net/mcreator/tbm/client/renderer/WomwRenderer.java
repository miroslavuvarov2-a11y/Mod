...
public class WomwRenderer extends EntityRenderer<WomwEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/textured1.png");
   private final Modeld6 model;

   public WomwRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modeld6(context.m_174023_(Modeld6.LAYER_LOCATION));
   }

   public void render(WomwEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(WomwEntity entity) {
      return texture;
   }
}
