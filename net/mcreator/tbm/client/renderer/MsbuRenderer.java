...
public class MsbuRenderer extends EntityRenderer<MsbuEntity> {
   ...
   public MsbuRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelarrow(context.m_174023_(Modelarrow.LAYER_LOCATION));
   }

   public void render(MsbuEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(MsbuEntity entity) {
      return texture;
   }
}
