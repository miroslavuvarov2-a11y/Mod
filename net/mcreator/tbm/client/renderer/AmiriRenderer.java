...
public class AmiriRenderer extends EntityRenderer<AmiriEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/ert.png");
   private final Modelgold1 model;

   public AmiriRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelgold1(context.m_174023_(Modelgold1.LAYER_LOCATION));
   }

   public void render(AmiriEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(AmiriEntity entity) {
      return texture;
   }
}
