...
import net.mcreator.tbm.entity.model.MutantIronGolemModel;
...
public class MutantIronGolemRenderer extends GeoEntityRenderer<MutantIronGolemEntity> {
   ...
   public void preRender(PoseStack poseStack, MutantIronGolemEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 1.0F;
