...
public class TdRenderer extends EntityRenderer<TdEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/mdrowned.png");
   private final Modeltd model;

   public TdRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modeltd(context.m_174023_(Modeltd.LAYER_LOCATION));
   }

   public void render(TdEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(TdEntity entity) {
      return texture;
   }
}
