...
public class SlamRenderer extends EntityRenderer<SlamEntity> {
   ...
   public SlamRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelgold1(context.m_174023_(Modelgold1.LAYER_LOCATION));
   }

   public void render(SlamEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(SlamEntity entity) {
      return texture;
   }
}
