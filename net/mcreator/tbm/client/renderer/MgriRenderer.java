...
public class MgriRenderer extends EntityRenderer<MgriEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/dry.png");
   private final Modeledds model;

   public MgriRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modeledds(context.m_174023_(Modeledds.LAYER_LOCATION));
   }

   public void render(MgriEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(MgriEntity entity) {
      return texture;
   }
}
