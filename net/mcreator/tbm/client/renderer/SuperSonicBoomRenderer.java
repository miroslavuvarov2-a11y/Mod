...
public class SuperSonicBoomRenderer extends EntityRenderer<SuperSonicBoomEntity> {
   private static final ResourceLocation texture = new ResourceLocation("themutantmobsmod:textures/entities/ty.png");
   private final Modelgold1 model;

   public SuperSonicBoomRenderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelgold1(context.m_174023_(Modelgold1.LAYER_LOCATION));
   }

   public void render(SuperSonicBoomEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(SuperSonicBoomEntity entity) {
      return texture;
   }
}
