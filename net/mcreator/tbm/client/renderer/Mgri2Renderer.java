...
public class Mgri2Renderer extends EntityRenderer<Mgri2Entity> {
   ...
   public Mgri2Renderer(EntityRendererProvider.Context context) {
      super(context);
      this.model = new Modelgold1(context.m_174023_(Modelgold1.LAYER_LOCATION));
   }

   public void render(Mgri2Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(Mgri2Entity entity) {
      return texture;
   }
}
