...
public class Modelgold1<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("themutantmobsmod", "modelgold_1"), "main");
   public final ModelPart bone;

   public Modelgold1(ModelPart root) {
