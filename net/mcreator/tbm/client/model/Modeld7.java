...
public class Modeld7<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("themutantmobsmod", "modeld_7"), "main");
   public final ModelPart bone3;
   public final ModelPart bone2;
   public final ModelPart bone;
   public final ModelPart bone4;

   public Modeld7(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition bone3 = partdefinition.m_171599_("bone3", CubeListBuilder.m_171558_(), PartPose.m_171419_(0.0F, 24.0F, 0.0F));
